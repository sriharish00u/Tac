...
// Quiz functionality - Updated for 25 questions
// Define checkQuiz function globally so it can be called from onclick
function checkQuiz() {
    const correct = ['b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'c', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b'];
    let score = 0;
    let answered = 0;
    ...
    if (resultDiv) {
        ...
        resultDiv.innerHTML = `
            <h3>Your Score: ${score} / 25 (${percentage}%)</h3>
            <p>${message}</p>
            <p style="margin-top: 1rem; font-size: 0.9rem; color: #64748B;">
                Questions answered: ${answered}/25
            </p>
